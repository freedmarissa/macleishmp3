...
newsite1 <- data.frame(lat = 
42.454198, lon = -72.683603)
```
...
leaflet() %>%
  addTiles() %>%
  addPolylines(data = macleish_contours, color = "green", weight = 2) %>%
  addPolygons(data = allbuffers_inside2, weight = 1, opacity = 1) %>%
