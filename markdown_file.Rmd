...
```{r, warning=FALSE, message=FALSE, fig.cap="The green lines correspond to the elevation contours, the blue lines correspond to streams, the black lines correspond to trails, the black areas are buildings, and the popups correspond to the locations of current campsites and our first proposed site."}
...
```{r, warning=FALSE, message=FALSE, fig.cap="The green lines correspond to the elevation contours, the blue lines correspond to streams, the black lines correspond to trails, the black areas are buildings, and the popups correspond to the locations of current campsites and our second proposed site."}
